...
module.exports = {
  ...
  body: (p) => {
    ...
    const front_switch = `
          (fp_text reference "${p.ref}" (at -3.6 0 ${
      -90 + p.rot
          ...
          (pad 2 smd rect (at -1.735 -0.75 ${
            90 + p.rot
          }) (size 0.7 1.5) (layers F.Cu F.Paste F.Mask) ${p.from.str})
    ...
    const back_switch = `
        ...
        (fp_text user "${p.ref}" (at -3.5 0 ${90 + p.rot}) (layer B.SilkS) ${
      p.ref_hide
    }
        ...
        (pad 4 smd rect (at -1.735 2.25 ${
          270 + p.rot
        }) (size 0.7 1.5) (layers B.Cu B.Paste B.Mask) ${p.to.str})
        (pad "" smd rect (at -1.085 3.65 ${
          270 + p.rot
        }) (size 1 0.8) (layers B.Cu B.Paste B.Mask))
        (pad 5 smd rect (at -1.735 0.75 ${
          270 + p.rot
        }) (size 0.7 1.5) (layers B.Cu B.Paste B.Mask) ${p.from.str})
        (pad 6 smd rect (at -1.735 -2.25 ${
          270 + p.rot
