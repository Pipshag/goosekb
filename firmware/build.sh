...
(
  rm -rf fw/*.uf2
  cd zmk/app/
  west build -p -d ../../fw/left -b seeeduino_xiao_ble -- -DSHIELD=goose_left -DZMK_CONFIG="$(pwd)/../../../config" # west build -p -d ../../fw/left -b seeeduino_xiao_ble -DSHIELD=goose_left -DZMK_CONFIG="$(pwd)/../../../config"
)
(
  cd zmk/app/
